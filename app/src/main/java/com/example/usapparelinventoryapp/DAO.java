...
public class DAO extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //persian blue, NAVY, CANYON RED, DESERT SUN TURTLE BAY, MARLIN BLUE, FADED NAVY, TONE, BLACK SLATE, TEAL/H.GREY, BLUESKIES/H.GREY,MAROON/H.CHARCOAL, HEATHER GREY/H.CHARCOAL
        //HEATHER ASH/HEATHER NAVY, HEATHER GREY/BLACK, DUSTY ROSE, NAVY HEATHER, GREY HEATHER, SEAL, TRADEWINDS, VINTAGE BLUE, SAGE,CANTALOPE, SUNFLOWER, AUQA SPRINGS, FOSTED GARPE, PEACH & CREAM,
        // AQUARIUS, CORAL REEF, ECRU, FADDED PLUM, CARIBE, PINK SUGAR, SHADOW, SHELL, SMOKEY BLUE, DEMIM, GUNMETAL, PERSIAN BLUE, PARKRIKA, MINT, GRAPEFRUIT, GRAPHITE, GREY HEATHER, LIGHT BLUE, MELLOW YELLOW
        // SPEARMINT, CITRUS PUNCH, MULTI, SLAT WATER TAFFY, SEASHORE, STARFISH, ANTHRACITE, CANDY PINK, CREAMSICLE, TULIP, WHITE, CORAL, SUNNY, BLUE LAGOON, SEA GLASS
        // SKYBLUE, MAROON, MOSS, SALTY PINK, FLAMINGO, POWDER BLUE, MINERAL WASH, NECTAR, RED, OCEAN TEAL, CHARCOAL, CONCH, DOLPHIN, VIOLET, CALIENTE, STARBURST, PINK/SILVER, TIE-DYE, UNICORN
        // MAGICAL, MERMAID, TUTTI FRUTTI,SHADOW, COSMOS, STAR FISH, SEA SHORE, COSMOS, LAGOON, AQUA, TANGO RED, SEA SPRAY, DUSTY ROSE, SUNSET, MOONLIGHT, PASTEL SEA, RASTA
        // SEA GREEN, MILITARY GREEN, TURQOISE, PACIFIC BLUE, FLINT, STEEL, SALTY BLUE, COSATA BONITA, ROYAL, THE WAVE, GREY STONE, INDIGO, PERI HATHER, AMERICANA
        // COTTON CANDY, TURTLE BAY, DESERT SUN, EVERGREE, TAUPE, COCOA, LIGHT PINK, OATMEAL, CAMEL, LODEN, ONYX, EUCALYPTUS, FOSSIL, STEEL, WAVE, GUAVA, COASTAL, CRUSH
        // RIP CURL, JIUCY,GALAXY, SCUBA GREY, POOLSIDE, SILVER, KAUAI, BLUE/GREEN, DUSTY BLUE, NAVY/DENIM, SILVER/PINK, TURQUOISE/SHELL, MIDNIGHT, OCEANA, COBALT, BUTTERCUP, ROSE, HOT PINK, HOT AQUA, CHARCOAL/CREAM, NAVY/DENIM, DENIM/CREAM, GREY/CHARCOAL
        // ATHLETIC GREY HEATHER, BLACK HEATHER,
